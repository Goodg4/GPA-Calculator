    ...
    private static void setCourseInfo() {
        ...
        while (exitCondition) {
            ...
            try {
                ...
                System.out.println("Number of courses taken this semester? ");
                int numberOfCourses = input.nextInt();

                if (numberOfCourses <= 0) {
                    throw new NumberOfCoursesException("Number of courses cannot be less than or equal to zero.");
                }
                ...
                System.out.println("Input names of the courses and your performance in each of them.");
                int index = 0;
                    ...
                    try {
                        ...
                        if (creditUnits[index] <= 0 || coursePerformance[index] < 0 || coursePerformance[index] > 100
                            ...
                            throw new IncorrectDataException(
                                    "Data input is incorrect. Restart the program and try again.");
                        }
